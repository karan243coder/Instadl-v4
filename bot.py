...
def send_telegram_media_with_rate_limit(chat_id, media_data, media_type, caption_text):
    ...
    Supports both direct URL strings and open file objects.
    """
    retries = 5
    while retries > 0:
        try:
            if media_type == "video":
                ...
                return bot.send_photo(chat_id, media_data, caption=caption_text, parse_mode="HTML")
        except ApiTelegramException as e:
            if e.error_code == 429:
                # Extract retry seconds from exception or message description
                ...
                # Raise other errors (like 400 Bad Request) to trigger local fallback
                raise e
        except Exception as e:
